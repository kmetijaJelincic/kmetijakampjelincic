      ...
      return this.each(function () {
        ...
        var gallery = {
          ...
          initPictures: function () {
            obj.find("." + regs.target).each(function () {
              ...
              if (elem.is("img")) {
                ...
                var title =
                  elem.attr("alt") != undefined && elem.attr("alt") != ""
                    ? elem.attr("alt")
                    : elem.data("title") != undefined &&
                        elem.data("title") != ""
                      ? elem.data("title")
                      : "";
          ...
          buildLine: function () {
            ...
            var margins =
              (gallery.line.items.length - 1) * parseInt(regs.margin);
          ...
          loadPicture: function () {
            ...
            var url = item_line.picture
              .data("url")
              .replace(/(^url\()|(\)$|[\"\'])/g, "");
            var o_image = $("<img>", {
              alt: item_line.picture.data("title") || "",
            });
            ...
            _img.onload = function () {
              ...
              item_line.height =
                _img.height > regs.max_height ? regs.max_height : _img.height;
              item_line.width =
                _img.height > regs.max_height
